...
public class SwaggerTestData {
    ...
    public Map<String,Object> expectedDataSetUp(String username,String firstname,String lastname, String email,String password ,String phone, Integer userStatus){
